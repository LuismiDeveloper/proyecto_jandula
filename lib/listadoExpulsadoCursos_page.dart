...
import 'package:proyecto_jandula/listadoExpulsadoAlumnos_page.dart';
...
class ListadoExpulsadoCursosPage extends StatefulWidget {
  @override
  _ListadoExpulsadoCursosPageState createState() => _ListadoExpulsadoCursosPageState();

}

void main() => runApp(ListadoExpulsadoCursosPage());

class _ListadoExpulsadoCursosPageState extends State<ListadoExpulsadoCursosPage> {
  ...
  Future<ListaDatos> obtenerDatos() async {
    ...
    setState(() {
      ...
      listaDatos.removeWhere((item) => item['Tipo'] != 'Expulsado');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Cursos con expulsados"),
      ),
          ...
          itemBuilder: (BuildContext context, int index) {
            return OutlineButton(
              ...
              onPressed: (){
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ListadoExpulsadoAlumnosPage()),
                );
